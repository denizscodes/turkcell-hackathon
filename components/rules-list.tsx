...
export function RulesList() {
  ...
  return (
    <>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3 text-sm">
                    ...
                    <div>
                      ...
                      <span className="ml-2 font-semibold">{rule.priority}</span>
                    </div>
                    <div>
                      <span className="text-muted-foreground">Executions:</span>
                      <span className="ml-2 font-semibold">{rule.executionCount}</span>
                    </div>
                  </div>
      ...
      <CreateRuleDialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen} onSuccess={fetchRules} />
    </>
  )
}